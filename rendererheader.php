...
class HeadRenderer extends DocumentRenderer
{
	...
	public function fetchHead($document)
	{
		...
		//if ($document->isHtml5())
		//{
		//	$buffer .= $tab . $tab . '<meta charset="' . $document->getCharset() . '" />' . $lnEnd;
		//}
		...
		if (!empty($base))
		{
			$buffer .= $tab . $tab . '<base href="' . $base . '" />' . $lnEnd;
		}
		...
		//		{
		//			$buffer .= '<meta http-equiv="' . $name . '" content="' . htmlspecialchars($content, ENT_COMPAT, 'UTF-8') . '" />';
		//		}
		...
		//				{
		//					$buffer .= '<meta ' . $type . '="' . $name . '" content="' . htmlspecialchars($value, ENT_COMPAT, 'UTF-8') . '" />' .;
		//				}
		//			}
		//			else
		//			{
		//				$buffer .= '<meta ' . $type . '="' . $name . '" content="' . htmlspecialchars($content, ENT_COMPAT, 'UTF-8') . '" />' .;
		//			}
		//		}
		//	}
		//}
      
      	$buffer .= $tab . $tab . '<title>' . htmlspecialchars($document->getTitle(), ENT_COMPAT, 'UTF-8') . '</title>' . $lnEnd;
		...
		{
			$buffer .= $tab . $tab . '<meta name="description" content="' . htmlspecialchars($documentDescription, ENT_COMPAT, 'UTF-8') . '" />' . $lnEnd;
		}
